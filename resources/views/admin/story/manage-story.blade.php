                        ...
                        <div class="table-responsive">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($stories as $story)<tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin-view-story-details',['id'=>$story->id])}}" class="btn btn-info btn-sm" title="View Details">
                                                <span class="fa fa-eye"></span>
                                            </a>
                                            <a href="{{route('admin-view-story-comment',['id'=>$story->id])}}" class="btn btn-success btn-sm" title="View Comments">
                                                <span class="fa fa-comment"></span>
                                            </a>
                                            @if($story->story_status==1)
                                                <a href="{{route('make-unlisted',['id'=>$story->id])}}" class="btn  btn-danger btn-sm" title="Make Unlisted">
